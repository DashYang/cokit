...
<script type="text/javascript" src="./cokitjs/app/map/client/customizedService.js"></script>
...
<script type="text/javascript" src="./cokitjs/app/map/client/userInterface.js"></script>
